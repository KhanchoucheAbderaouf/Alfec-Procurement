  ...
  initForm() {
    this.formGroup = new FormGroup({
      ...
      parametres: new FormGroup({
        ...
        debitsoufflage: new FormControl(this.data.result.parametres.debitsoufflage),
        debitextraction: new FormControl(this.data.result.parametres.debitextraction),
        debitreprise: new FormControl(this.data.result.parametres.debitreprise),
