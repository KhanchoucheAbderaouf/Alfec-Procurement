...
@Component({
  selector: 'app-rtsearchresults',
  templateUrl: './rtsearchresults.component.html',
  styleUrls: ['./rtsearchresults.component.css']
})
export class RtsearchresultsComponent implements OnInit {
  Modif : string;
  Supp : string;
