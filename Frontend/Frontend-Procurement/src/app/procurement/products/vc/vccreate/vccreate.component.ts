  ...
  initForm() {
    this.formGroup = new FormGroup({
      ...
      parametres: new FormGroup({
        ...
        treprisehiver : new FormControl("",[Validators.required]),
        trepriseete: new FormControl("", [Validators.required]),
        threprise: new FormControl("",[Validators.required]),
        tsoufflagehiver: new FormControl("", [Validators.required]),
        tsoufflageete: new FormControl("", [Validators.required]),
        thsoufflage: new FormControl("", [Validators.required]),
        vitesseselection: new FormControl("", [Validators.required]),
        couleurcarrosserie: new FormControl(""),
        niveausonore: new FormControl("", [Validators.required]),
        pressiondisponible: new FormControl("", [Validators.required]),
