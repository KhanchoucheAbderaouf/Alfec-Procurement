...
@Component({
  selector: 'app-evapsearch',
  templateUrl: './evapsearch.component.html',
  styleUrls: ['./evapsearch.component.css']
})
export class EvapsearchComponent implements OnInit {
  submitted = false;
  response : any[] = []
  formGroup: FormGroup;
  ...
  public allproducts() {
    ...
    return this.http.get(this.url.urlAddress + ":8082/procurement/products/index/EVAP",{headers,responseType:'json' as 'json'})
    .subscribe((data : any)=>{
