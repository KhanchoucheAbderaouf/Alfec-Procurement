...
@Component({
  selector: 'app-chdsearchresults',
  templateUrl: './chdsearchresults.component.html',
  styleUrls: ['./chdsearchresults.component.css']
})
export class ChdsearchresultsComponent implements OnInit {
  Modif : string;
  Supp : string;
